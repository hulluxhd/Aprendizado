; (function () {
	...
	function Task(name, completed, createdAt, updatedAt){
        ...
        this.toogleDone = function(){this.completed = !this.completed}
		this.getName = () => _name
    ...
    /* arrTasks.map(function(obj){
        let {name, completed, createdAt, updatedAt} = obj
    ...
    function addTask(name, completed, createdAt, updatedAt) {

        const novaTarefa = new Task(name, completed, createdAt, updatedAt)
        arrInstancesTasks.push(novaTarefa)
        renderTasks()
